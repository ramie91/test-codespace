...
Make sure to set the `Allocation unit size` to the smallest option available (example `4096B`).
 ...
 ![SD card formatting options](assets/24be8eba-05f5-4813-b2de-1e2120ebdd50.redirect_id_24be8eba-05f5-4813-b2de-1e2120ebdd50)
...
2. Go to `Software update/versions > Versions`, select your current firmware version, go to `CPU` and and check CPU ID.
    ...
    ![Checking CPU ID number in update menu](assets/dc40d648-f0b9-4849-916d-7d0ee425f984.redirect_id_dc40d648-f0b9-4849-916d-7d0ee425f984)
