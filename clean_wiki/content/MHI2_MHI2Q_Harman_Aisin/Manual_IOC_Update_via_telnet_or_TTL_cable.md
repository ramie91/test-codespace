...
> 
>     ![](../../assets/6fe9ce58-8537-4da3-bb79-04401dc6d956.png)
> 
...
Unit will restart automatically and you will see update reboot screen on MMI
 ...
 ![](../../assets/7f97681e-acda-4fa5-9bf4-8d16c336b0e5.png)

## Update IOC App

`on -f rcc /usr/apps/mib2_ioc_flash updateAppNow`

 ![](../../assets/96a330be-3aba-4696-a81a-d2dd45836d14.png)
...
`on -f rcc /usr/apps/mib2_ioc_flash updateBoloNow`
 ...
 ![](../../assets/4508a0ef-d4e0-45d8-983d-bc8f5765df7d.png)
...
If you updated Bolo before App, RCC and MMX will loose EEPROM access and Train version and MU software will look like:
 ...
 ![EEPROM can not be acessed](../../assets/fd8d399b-d6fa-4e1c-a535-df701070bf60.png)

To fix this, repeat the steps starting from updateApp

# Reference

[IOC Update.pdf](../../assets/0404838e-efa5-4a42-b945-b18f036170d6.pdf)
