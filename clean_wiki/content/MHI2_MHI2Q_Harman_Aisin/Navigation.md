...
\
 ![](assets/eaeb86de-3ffc-4ab7-801f-142d6c68bacd.redirect_id_eaeb86de-3ffc-4ab7-801f-142d6c68bacd)There are a few things that can cause problems like this, we'll fix all of them as needed!
...
\
 ![](assets/5bf0bff3-92e2-4303-9d75-39cb5cdaea54.redirect_id_5bf0bff3-92e2-4303-9d75-39cb5cdaea54)   ![](assets/16127217-7797-4b73-85b3-85893c41bf7c.redirect_id_16127217-7797-4b73-85b3-85893c41bf7c)Go to Installed codes. It may have a list of codes like this (Valid or Invalid)

\
\
 ![](assets/a1c55a26-af15-4342-92b8-d9540ad5d20c.redirect_id_a1c55a26-af15-4342-92b8-d9540ad5d20c)Or it might be blank

\
\
 ![](assets/fbfcb94e-21b2-4678-875b-9a610553b5e6.redirect_id_fbfcb94e-21b2-4678-875b-9a610553b5e6)Either way, we need to make sure that a matching code for your brand & region has been added.
...
\
 ![](assets/ee0efd86-efff-4c55-af45-50263e07dbb0.redirect_id_ee0efd86-efff-4c55-af45-50263e07dbb0)Open up the “addFecs.txt” file in a good text editor like Sublime Text or Notepad++ (windows built in notepad is not always safe with regard to line endings)
...
\
 ![](assets/ee236832-c396-4dcc-a3a6-5f656575ec8f.redirect_id_ee236832-c396-4dcc-a3a6-5f656575ec8f)Save and close the file, eject the SD card and insert into SD1 on the unit.
...
\
 ![](assets/533e9524-4cad-43f0-a7a1-6ee15fb7fd92.redirect_id_533e9524-4cad-43f0-a7a1-6ee15fb7fd92)If you haven't already done so previously you should really run a backup.
...
\
 ![](assets/62196970-b4e0-49cc-b92f-6d5ef943ab5f.redirect_id_62196970-b4e0-49cc-b92f-6d5ef943ab5f)If that’s already set to the correct brand, move on to…
...
\
 ![](assets/78549f72-0ed5-495f-b73f-eb76ddf8de99.redirect_id_78549f72-0ed5-495f-b73f-eb76ddf8de99)if they're not marked Y you'll need to overide these. Go back to the Service Menu → Testmode → Green Engineering Menu.

\
Go to “production” → “rcc_prod” → “swdl_prod” and enable “User Define SWDL”

\
 ![](assets/70a91c56-3a31-4a30-93eb-876b109d209b.redirect_id_70a91c56-3a31-4a30-93eb-876b109d209b)Start “Service Menu” again, “Testmode” → “SWDL”

\
\
 ![](assets/26758691-6786-4cbd-94a5-6a7d12da4478.redirect_id_26758691-6786-4cbd-94a5-6a7d12da4478)Click on “Software Download Manual Download”. It may or may not show a checkbox, just click on it once either way.Tthen click on “Start Download”.
...
\
 ![](assets/989a5929-6055-4042-bc08-cfbe2f1865db.redirect_id_989a5929-6055-4042-bc08-cfbe2f1865db)I had to re-try with different SD cards and a different map download pack a few times, usually with a different error on screen each time.  Eventually it settled on showing this error a few times in a row, even with different map versions on different media.
