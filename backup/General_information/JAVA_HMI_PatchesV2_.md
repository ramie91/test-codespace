...
If you want a shorter text, change the length counter of there String  before the Text
 ...
 ![](/api/attachments.redirect?id=b7f8b53a-ef24-418b-bea3-b1ed5db0676e)
...
(String)"CancelLabel" in the init function does not seem to have much technical use, maybe only for logging. so lets try to reuse this.
 ...
 ![](/api/attachments.redirect?id=731dc948-4aa9-4362-b929-33c2e8b5d45d)

do a test and decompile the patched JXE, now the init function changed. 

Do a MIB2 test, the Popup still works.

 ![](/api/attachments.redirect?id=cadea15d-8cd0-4063-acec-b344fe903e87)Why? Lets have a look on the JAR Bytecode now. 
...
if you did not find it lets take just more code  above/ below
 ...
 ![](/api/attachments.redirect?id=185843db-4dd7-4fcf-9ed5-052f57c0117f)

\
So lets see what we really want to change and look on the desired endresult

\
 ![](/api/attachments.redirect?id=0a4957b0-dd36-43e4-8fe1-9b63804789d3)so lets swap the first ldc reference from \[56\](released) to \[47\](cancelLabel now “ViewEntered”)

you can spot Line/Byte 16+18 and 42+44  from the code above here:

 ![](/api/attachments.redirect?id=875c939a-06b0-4507-a994-b5644af48a9c)and attach the same event as for the widget 7 (confirm button)  by swapping the ldc reference \[57\] to \[58\]
...
\
 ![](/api/attachments.redirect?id=b4423f24-29de-407d-91f5-89970cf27b3e)This is all done by looking up the command values like iconst_4, aaload, invokeinterface etc.. and thus finding the correct occurrence in the JXE binary data.
