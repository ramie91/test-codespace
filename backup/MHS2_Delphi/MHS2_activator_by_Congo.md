...
7. Insert the SD card into `SD1` slot and wait. Activator will start automatically and you should see a screen like:
    ...
    ![](/api/attachments.redirect?id=cdb66214-0b86-40f8-b647-19b8be405f18)
8. It may take up to 5 minutes and MIB can reboot. Just wait for green screen with the “completed successsully” message:

 ![](/api/attachments.redirect?id=a1e147d4-af23-4161-9cbd-e8ea0a50a69e)
...
**GOOD TO KNOW!** Sometimes it may happen that you do not see the green screen. Then just remove SD card, insert into laptop and check log.txt. It should contain something like:
 ...
 ![](/api/attachments.redirect?id=0a61716d-5409-4ecc-b426-d375489f73b2)
...
025D00F0 Lifetime RoW maps](/api/attachments.redirect?id=247aef7d-d584-4a82-8109-a8655393cbc4)
...
:::
 ...
 ![Charge only USB port (on the left) and 2xUSB port hub compatible with Smartfone interface (on the right)](/api/attachments.redirect?id=943e8d06-b6ad-404a-b538-e1f177174807)

## Old dlphi.sh scripts for the learning purposes

[MHS2 MU0129 SDCard auto patch.7z](/api/attachments.redirect?id=ba1cadb4-3f91-4e3e-bb9b-150af5b1e59c)

[MHS2 MU2035 SDCard auto patch.7z](/api/attachments.redirect?id=d8712818-b22d-4ae8-8d52-e8d9273a25b5)
