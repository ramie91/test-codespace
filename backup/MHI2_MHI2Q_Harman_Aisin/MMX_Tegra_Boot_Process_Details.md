...
\
For reference I used the following script to handle merging partitions into one binary image, feel free to play around with it: [create_image.py](/api/attachments.redirect?id=7146202c-106d-4623-a022-8837a472504c)

\
Also useful is the [Tegra3_publicTRM_DP05644001_v03.pdf](/api/attachments.redirect?id=3e39d466-d7f6-4f8d-91da-fb043e9fd9c8)
