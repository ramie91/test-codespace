...
### CRC = is the CRC32 of all update.txt lines WITHOUT the CRC line (including \\n) - in this example: `CRC = 4ff4205f`
 ...
 ![CRC line removed](/api/attachments.redirect?id=13d4a9fd-8ec6-4ed1-abcd-9d2f20070792)

If you calculate CRC32 of the`update.txt`with the CRC line, SWDL will consider the file as damaged:            ![CRC32 of update.txt does not fit](/api/attachments.redirect?id=6abb8622-b8b8-47b5-933e-8698bf5e18a7)
...
Example from FW MHI2_ER_AU43x_P5098
 ...
 ![SHA1 hash matches](/api/attachments.redirect?id=513f50a5-7389-46fa-880c-382f6c80380f)
...
:::
 ...
 ![](/api/attachments.redirect?id=bedf6dab-16bf-4afc-899c-1da9c901640d)
...
\[RCC\\0\\ifs-root\\32\\default\\application - similar to the line in metainfo2.txt with adding a device number\]===Status (see below)==;`version of the module in unit`;default(unknown)`target version on SD/USB card update`
 ...
 ![section from metainfo2.txt for MHI2_ER_AU43x_P5098](/api/attachments.redirect?id=203f10de-87d2-4165-abc0-3d48f84a13ac)
...
| RCCversion = U8228 |    | ? |
| AssemblyID = 0 |    | ? |
| ReleaseName = MHI2_ER_AU43x_P5098 | Pulled from metainfo2.txt \n   ![](/api/attachments.redirect?id=13b05c2c-a0b0-49fb-b85e-aac0152e39c6) | ? |
| startTime = 2021-10-07 14:09 |    | ? |
...
| {RCC\\Post}=TODO; |    | ? |
| {RCC\\Pre}=DONE; |    | ? |
| {Final}=TODO; | Status of FinalScript in metainfo2.txt \n   ![](/api/attachments.redirect?id=10203f16-7dc7-4f5f-9e7e-1e2c763d88f1) | ? |
