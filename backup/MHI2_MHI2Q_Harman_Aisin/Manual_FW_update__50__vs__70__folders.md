...
Most (if not all) FW updates have two subfolders within the MMX2 update packages
 ...
 ![MU1447 - efs-sys](/api/attachments.redirect?id=c4f91842-7128-4423-a187-c3c9c9020c06)
...
e.g. eifs does not have a `70` folder and therefore `/50/` is used in all cases.
 ...
 ![MU1447 - eifs](/api/attachments.redirect?id=22027b44-7218-4657-b42b-f6cac2babaa7)
...
[ images.zip](/api/attachments.redirect?id=f66cf523-bdcd-40a1-bc3d-d028a9103e16)
