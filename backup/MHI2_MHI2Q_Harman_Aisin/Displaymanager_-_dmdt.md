...
`use` does not provide any output
 ...
 ![](/api/attachments.redirect?id=15699f65-7cc8-4e97-9e25-ac5c454c4c28)

# /eso/bin/apps/dmdt

Debug Tool for DisplayManager

 ![](/api/attachments.redirect?id=659f32b5-ec78-46fa-9895-0528b5989379)

## dm 0 on

upper left corner image is the main screen, also changes with pressing of buttons on unit

 ![](/api/attachments.redirect?id=d7eb4b7a-acb9-401e-b844-f4e355b7b7ce)             ![](/api/attachments.redirect?id=aedeaf92-fb4a-4f37-a239-38b1bc655e3b)
...
List of available outputs and their resolutions
 ...
 ![](/api/attachments.redirect?id=bba6ea0b-eea7-48bc-9891-4170ed9ef3ba)
...
### With just internal MIB main screen (G13 9.2’’):
 ...
 ![](/api/attachments.redirect?id=02a07153-90b7-487c-8e56-7b3ec7d9fd4a)
...
which allows for certain manipulation based on the commands below.
 ...
 ![from displaymanger.json - id:4 for Cluster Display](/api/attachments.redirect?id=5fb0555a-89af-4ce7-977e-1708bf75e800)
...
\
 ![](/api/attachments.redirect?id=90f05d00-368a-4cc6-a1b6-885096314f1e)

\
 ![](/api/attachments.redirect?id=92e47f07-1de1-4880-aa41-0c404f96fab8)
...
\
 ![](/api/attachments.redirect?id=0871642b-91c2-4447-990f-3fb3ab50d03f)
...
\
 ![](/api/attachments.redirect?id=0960481e-6a63-46c8-8db0-7c892ef9cc9d)

Animated gifs are not working

\
[ showscreen.sh](/api/attachments.redirect?id=606a48bc-9e65-4058-9139-c951a2d222b5)
...
\
 ![](/api/attachments.redirect?id=2e7b1cfe-bf6d-4520-9519-7220cf3f5767)
...
In `/etc/eso/production/gal.json` video dump can be enabled and in /tmp files like `AAPDumpVideoSink_1970-01-01_12-12-25.h264` will be crated, which can be converted to mp4 and viewed in vlc etc - recording a full screen view of everything that happens:
 ...
 ![](/api/attachments.redirect?id=3fe18e33-e8a1-4211-b11a-ce2eedd67c14)
