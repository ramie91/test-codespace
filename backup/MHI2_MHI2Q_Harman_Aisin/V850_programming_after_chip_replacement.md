...
* On the unit side you can make the connection directly to the chip or find test pads on the board with a multimeter:
 ...
 ![](/api/attachments.redirect?id=cb6dcde3-f370-417d-9d17-ba2489537b04)

 ![](/api/attachments.redirect?id=55923905-86e1-4440-b3ed-efb31c72e0c4)
...
* On the FT232 TTL adapter side:
 ...
 ![](/api/attachments.redirect?id=8c2cf1bb-00b3-44e2-92a4-3c86a0fb6a22)
...
* Full mode:
   ...
   ![](/api/attachments.redirect?id=cdf1fbbe-60d2-4e23-accc-221e97d7cb5e)
* Select chip:

   ![](/api/attachments.redirect?id=286ebd50-7d8e-4fe1-a8f9-09f85814c6ea)
* Select COM port (check in Windows Device Manager):

   ![](/api/attachments.redirect?id=bac12089-59a5-451e-93fd-20c0dc33115a)
* Interface Speed 115,200bps, Frequency (4.00Mhz):

   ![](/api/attachments.redirect?id=a3e20039-b082-42db-83af-66f0f8431af4)

**Select V850bolo_MQB.bin:**

\
 ![](/api/attachments.redirect?id=aedde788-ba13-4a01-bba8-e29843cc65d1)
