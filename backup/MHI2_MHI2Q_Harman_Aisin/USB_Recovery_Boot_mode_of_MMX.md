...
\
\
 ![](/api/attachments.redirect?id=c6c45ea1-6ca0-427c-81b3-ab0ecced4352)
...
Once you get it off though, the main PCB will be exposed:
 ...
 ![](/api/attachments.redirect?id=9f46df82-d060-4cb8-9107-cb3b4c95f3af)

Jumping these two pads together while powering on the MIB will force the MMX to boot in USB recovery mode.

\
 ![](/api/attachments.redirect?id=3d59fb91-3f3e-4151-bb77-78d848564764)

If you expect to use USB recovery mode often then you can solder a switch there:

 ![](/api/attachments.redirect?id=3028a58c-1f43-48df-a9fa-c1bc3e723805)
...
[ tegram_rcm_usbpcdriver_32_64.zip](/api/attachments.redirect?id=874199d3-1a31-4ec9-a07c-a8b008268529)

Once driver is installed you can run nvflash_3.1.zip

[ nvflash_3.1.zip](/api/attachments.redirect?id=9ec7bf62-a191-425d-84da-d5c816c1bd30)
