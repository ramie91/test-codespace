...
|----|----|----|
| Putty | `CTRL`+ `BREAK` |  ![](/api/attachments.redirect?id=0a300856-d811-48f9-a3be-b17574104d4b) |
...
3. On some firmwares, first you need to power on the unit and only then quickly press and hold the Ctrl+Pause key combination for about 1 second until you see the “BREAK detected” line:
 ...
 ![](/api/attachments.redirect?id=98d15735-5db3-4078-8bf3-4ec5581bb857)


4. Press any key and you should see a confirmation: “BREAK accepted!” and CLI (command line interface) prompt:

 ![](/api/attachments.redirect?id=02100849-a28f-418a-9d13-63d3b3640852)
...
## CLI command list reference
 ...
 ![list of CLI commands after you enter "help"](/api/attachments.redirect?id=0461e8e8-0643-4a71-a378-b3d9f5c67e4f)
