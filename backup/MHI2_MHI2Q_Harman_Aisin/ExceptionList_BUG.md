...
\
Use M.I.B and run the following command to replace EL with stock version (BUG free) and edit FecContainer.fec:      ![run "Add new FEcs to FecContainer.fec"](/api/attachments.redirect?id=ba9b9707-79fe-4d44-b454-8f2d34accd5a)
