...
Example of the Emergency IFS 1st boot:
 ...
 ![1st boot sequence - IOC watchdog will reboot Emergency IFS after 60 seconds](/api/attachments.redirect?id=e77e8232-41c7-4907-b5da-aaffb44ab86e)
...
\
 ![2nd boot sequence - Emergency EFS shows a countdown timer before reboot](/api/attachments.redirect?id=385959d6-956a-4958-9ee4-1cc4f172909c)If DeveloperMode is off (by default), to stop Emergency IFS’t timer from rebooting, you have to login via root with RCC emergency password and enter:
...
\
 ![2nd boot sequence - with enabled DeveloperMode](/api/attachments.redirect?id=55af4b04-4a14-4ebc-8a2e-b44df6b935e4)