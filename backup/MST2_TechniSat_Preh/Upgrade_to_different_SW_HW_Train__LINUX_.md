...
## Upgrade procedure
 ...
 1. Connect an SD card reader ([SD Card Readers (working/not working)](/doc/sd-card-readers-workingnot-working-bEzQx5OFBk)) to the eMMC through-hole plating (soldering or probes). For me the connection was only stable with DATA0 connected and DATA1-3 unconnected (-> slow read & write)
