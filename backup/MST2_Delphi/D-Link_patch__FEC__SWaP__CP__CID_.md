...
* To recognize the unit without removal, it is necessary to hold down the MENU button on the radio for 3 seconds to open hidden service mode. In this menu go to `Software Update/Versions` and check `SW Train`.
  ...
  \
   ![Service mode available after holding MENU button for 3 seconds.](/api/attachments.redirect?id=731125ca-a3ae-4b6c-a580-69a90bd843e0)                                          ![SW Train example with European Volkswagen firmware.](/api/attachments.redirect?id=73723d74-4ee7-4501-bd99-a6bdc6de93aa)
* Delphi SW Train Version scheme example: `MST2_EU_VW_P0891D`.
 ...
 ![](/api/attachments.redirect?id=83405590-6e06-4d6a-9949-9f381002fd5b)

\
 ![Delphi SW Train Scheme](/api/attachments.redirect?id=0c0ef38b-8204-48c2-8355-7b8d9c80da75)
...
## Network settings
 ...
 ![](/api/attachments.redirect?id=9c872184-f400-4c76-a01b-6cb3a76495fe)

 ![](/api/attachments.redirect?id=20bed7c2-72a1-4e96-aa5a-dbdebb2ffccc)
...
:::
 ...
 ![](/api/attachments.redirect?id=0c4facc7-8828-4032-83bf-f487b436a2aa)
...
5. Press the MENU button on the radio longer until another (service) menu opens. Select the test mode there.
    ...
    ![](/api/attachments.redirect?id=775f4134-1c54-461d-a606-38d85db6f4b1)
6. Switch to the "SWDL" category.

    ![](/api/attachments.redirect?id=327f9c3a-bb45-47bd-bf1d-9408ce878891)
7. Activate Software Download Manual Download and tap "Start Download".

    ![](/api/attachments.redirect?id=6441ca2d-f584-49d3-ae33-4523214aeff9)
8. Select source (SD card), select everything and start firmware update.

    ![](/api/attachments.redirect?id=6bec0955-597d-4bce-9452-4333a2eb8174)
...
\
 ![](/api/attachments.redirect?id=82eccf29-8c19-4bf5-aeaa-6425077e9118)

Select `Green Engineering Menu`

(optionally you can also get there directly by pressing the MENU button for a very long time)

 ![](/api/attachments.redirect?id=beeab519-370e-452b-a7da-ee08451035ad)

Change to the category "debugging mlp"

 ![](/api/attachments.redirect?id=2aee805a-8803-4d80-8ea4-daa339f88b27)

Check `Ethernet` box and restart the unit (hold down the power button for at least 10 seconds)

 ![](/api/attachments.redirect?id=051a4c9d-210d-425e-9062-cb724b4bcc03)
...
After the unit has been restarted enter same menu again and also check `Switch to MLP` must be checked. (Note: If only removing CP, it does not seem MLP needs to be selected 8/7/2023)
 ...
 ![](/api/attachments.redirect?id=9c514631-8649-43c4-babe-bd13518cfe14)
...
IP `192.168.1.4`  and port `23` are default on all units.
 ...
 ![Click open to connect to unit](/api/attachments.redirect?id=77c2892a-2f95-43ed-8102-e8c788774938)
...
Only the word `root` (NO password) is required as a login to Delphi units.
 ...
 ![](/api/attachments.redirect?id=d8d8a43d-a8f5-413f-8c2f-ecd1d061d3b6)

As soon as `Welcome` is shown, commands can be entered.

 ![](/api/attachments.redirect?id=619b37b2-9a1d-4308-96b3-73ea1d2ed588)
...
\
 ![](/api/attachments.redirect?id=ebc8aa25-ee68-4042-9af1-f07ad31d29fe)
...
# [FEC Generator](https://www.digital-eliteboard.com/threads/mib2-delphi-fec-generator-by-xtr3m3.495976/)
 ...
 ![](/api/attachments.redirect?id=523b3a29-5274-4af4-9aa2-3b7d80ceb25f)
