...
**MMC1:** System partition, contains **START.BAT** that runs **/MAIN/CPU_HMI.EXE** ![](/api/attachments.redirect?id=9eec0d81-9b51-4750-9c03-5c45400a66f9)

**MMC2:** Resources (esd menu, fonts, images.mif, skin1, ringtones) ![](/api/attachments.redirect?id=bb16ca5e-0063-4d50-8ba4-38a36edce2e1)

**MMC3:** Storage for persistence, errors, screenshots etc ![](/api/attachments.redirect?id=addfe058-81ef-4cb5-8e71-2f0ccf4031cb)

**MMC4:** Navigation binary and resources ![](/api/attachments.redirect?id=d4b8bfe7-fd16-4c3b-bb07-de10856f8a68)

**MMC5:** Speech (svox_res) resources\n ![](/api/attachments.redirect?id=60ea47a7-0980-4776-8b6e-b656856e54c2)

**MMC6:** Contains copy of **NVM_DB**

**MMC7:** Contains public keys for checking signatures of data, SWaP/FECs, metainfo2.txt and FECs in **FEC_DB** file: ![](/api/attachments.redirect?id=84fa0909-5352-4415-a60d-8953c41a633e)
